...
ActiveRecord::Schema[7.0].define(version: 2024_09_02_213445) do
  ...
  create_table "trading_stats_monthlies", force: :cascade do |t|
    t.datetime "recorded_date"
    t.float "balance_btc"
    t.float "balance_btc_sats"
    t.float "balance_usd"
    ...
    t.float "lose_streak"
    t.float "draw_streak"
    t.float "last_12m_wins"
    t.float "last_12m_losses"
    t.float "last_12m_draws"
    t.float "net_balance_change_btc_absolute"
    t.float "net_balance_change_btc_sats_absolute"
    t.float "net_balance_change_usd_absolute"
    t.float "net_balance_change_usd_cents_absolute"
  ...
  create_table "trading_stats_yearlies", force: :cascade do |t|
    t.datetime "recorded_date"
    t.float "balance_btc"
    t.float "balance_btc_sats"
    t.float "balance_usd"
